        ...
        <div class="search_filter_box">
            ...
            <div class="width100">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                    <form class="search" action="manage-reports-miscellaneous" method="get" role="form" id="searchForm" >
                              {{ csrf_field() }}  
                        ...
                        <div class="row">
                            ...
                            <select id="myDropdown" multiple name="vendor_id[]"  class='chosen-select'>
                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <a class="btn btn-danger ml-2"  style="margin:0px !important" href="{{ENV('APP_URL')}}manage-reports-miscellaneous" role="button">Cancel</a>
                            </div>
            ...
            @if(!empty($vendorwise_data) )
                ...
                <div id="All" class="tabcontent" style="display:block;" >
                    <table id='empTable' class="table table-striped table-responsive table-hover" >
                      ...
                      <tbody>
                          <?php $final_total=0; ?>
                          <?php for($i=0;$i<count($vendorwise_data);$i++){ ?>
                          <?php $total=0; ?>
                               <tr class="text-center">
                                    <td>{{$i+1}}</td>
                                    <td><?echo $vendorwise_data[$i]['vendor_name'];?></td>
                                    <?php 
                                    $month_wise_data=$vendorwise_data[$i]['month_wise_data'];
                                    foreach($month_wise_data as $monthwisedata) {
                                    $data_m=$monthwisedata['total_creatives'];
                                    ?>
                                    <td><?php
                                    ...
                                    <td><?php echo $total;
                                           $final_total=$final_total+$total; ?></td>  
                    ...
                    <!--<div><hr> <h7> <b>Vendor Name :</b> {{$totaladvertisement['vendor_name']}} | <b>Total Advertisement :</b> {{$totaladvertisement['total_advertisement']}} | <b>Used Advertisement :</b> {{$totaladvertisement['use_advertisement']}}    </h7></div>-->
                    <!--@endforeach-->
...
@include('admin/footer')
  ...
  $(document).ready(function () {
  var element = document.getElementById("manage_reports_miscellaneous");
...
function openCity(evt, cityName) {
  ...
  evt.currentTarget.className += " active";
    ...
    setTimeout( $("#active").addClass("active") , 500);     
</script>
