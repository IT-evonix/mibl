...
<h4 class="singlefileupload"> Upload Miscellaneous Creative </h4>
   ...
   <div class="sign-in-up-form">
      <div class="tab-content">
         <div id="login">
            <div class="wrapper">
               <div class="container">
                  <form method="POST" action="{{ url('/insert_single_file_upload_vendor_miscellaneous') }}" enctype="multipart/form-data" id="singlefileupload"> 
                     {{ csrf_field() }}
                     <div class="row">
                     ...
                     <div class="row">
                              <label for="remark" class="ml-2">Remark</label>
...
<script>
   $(document).ready(function () {
    var element = document.getElementById("upload_miscellaneous");
...
<script>
   $(document).ready(function () {
   var element = document.getElementById("single_file_upload_vendor_miscellaneous");
   element.classList.add("active");
   });
</script>
<script>
