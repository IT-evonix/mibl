...
<h4 class="singlefileupload"> Edit Miscellaneous Creatives</h4>
      ...
      <div class="tab-content">
         <div id="login">
            <div class="wrapper">
               <div class="container">
                   @foreach($edit_services as $creatives)
                  <form method="POST" action="{{ url('/update_creative_vendor_miscellaneous') }}" enctype="multipart/form-data">
                     {{ csrf_field() }}
                     <div class="form-row">
                     ...
                     <input type="text" class="form-control" id="advertisement_id"
                           ...
                           <span id="advertisement_not_match" style="display:none"><b style="color:red;"></b></span>
...
<script>
   $(document).ready(function () {
   var element = document.getElementById("manage_creative_approve_miscellaneous");
...
function getids()
 {
      ...
      var _token = jQuery('input[name="_token"]').val();
      jQuery.ajax({
      url: "{{ENV('APP_URL')}}insert_creative_main_miscellaneous",
      method: "POST",
     ...
     if(result.success == '200'){
      ...
      window.location.href="{{ENV('APP_URL')}}view-creative-vendor-approved-miscellaneous";
      });
      }
...
<script>
$(document).ready(function () {
var element = document.getElementById("approve_miscellaneous_creatives");
element.classList.add("active");
