    ...
    display: block;
      ...
      <div class="container">
        ...
        <div class="search_filter_box">
            <h4>Search Approve Miscellaneous Creatives</h4>
            <div class="width100">
                <div class="row">
                
                    <div class="col-lg-8">
                    <form class="search" action="view-creative-vendor-approved-miscellaneous" method="get" role="form" id="searchForm" >
                              {{ csrf_field() }}  
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <a class="btn btn-danger ml-2"  style="margin:0px !important" href="{{ENV('APP_URL')}}view-creative-vendor-approved-miscellaneous" role="button">Cancel</a>
                            </div>
                  ...
                  <div class="ad_list_imagepopup">
                   ...
                   <?php }
                    ...
                    <div class="col-lg-2 manage_col4 ">
                        <div class=" ">
                            <?php 
                            $APP_URL=$_ENV['APP_URL']."edit-creative-vendor-miscellaneous/".base64_encode($creative->id);
                            ?>
