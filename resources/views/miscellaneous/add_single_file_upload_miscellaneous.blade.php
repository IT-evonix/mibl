...
<h4 class="singlefileupload"> Single Miscellaneous File Upload</h4>
   ...
   <div class="sign-in-up-form">
      <div class="tab-content">
         <div id="login">
            <div class="wrapper">
               <div class="container">
                  <form method="POST" action="{{ url('/insert_single_file_upload_miscellaneous') }}" enctype="multipart/form-data" id="singlefileupload"> 
                     {{ csrf_field() }}
                     <div class="row">
...
<script>
   $(document).ready(function () {
    var element = document.getElementById("add_single_file_upload_miscellaneous");
...
<script>
//   $(document).ready(function () {
//   var element = document.getElementById("single_file_upload_miscellaneous");
//   element.classList.add("active");
//   });
</script>
<script>
