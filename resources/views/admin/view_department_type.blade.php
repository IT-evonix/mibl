...
<li class="breadcrumb-item active" aria-current="page">Manage Department Type</li>
</ol>
</nav>

  <h4 class="viewdata"> Manage Department Type </h4>
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <div class="row">
              ...
              <!--<div class="col-md-1 offset-5">
                <a href="{{ENV('APP_URL')}}add-department-type"> <button type="button" class="btn btn-block btn-secondary">Add</button></a>

              </div>-->
            </div>
            <form method="POST" action="{{ url('/insert_department_type') }}">
            {{ csrf_field() }}
            <div class="row">
              <div class="col-lg-12 ml-4">
              <lable class="font-weight-bolder pr-2 add-lable">Department Type Name</lable> <input type="text" id="department_type_name" name="department_type_name" placeholder='Department Type Name' required>
                <button class="btn btn-success ml-2" type="submit">Submit</button>
                <a class="btn btn-danger ml-2" href="{{ENV('APP_URL')}}view-department-type" role="button">Cancel</a>
              </div>
            </div>
          </form>
          </div>
  ...
  var element = document.getElementById("department_type");
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $('#empTable').DataTable({
        ...
        //  ajax: "{{route('department_type.getdepartment_type')}}",
        ajax: "{{ENV('APP_URL')}}department_type/getdepartment_type",
         "language": {
            "infoFiltered":"",
