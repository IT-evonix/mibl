...
@include('admin/side-menu')
            ...
            <li class="breadcrumb-item"><a href="{{ENV('APP_URL')}}view-agreement">Manage Agreement Type</a></li>
            <li class="breadcrumb-item active" aria-current="page">Edit Agreement Type</li>
            </ol>
            </nav>         
            <h4 class="addeditdata"> Edit Agreement Type</h4>    
                ...
                <div class="sign-in-up-form mt-5">
                    <div class="tab-content">
                        <div id="login">
                            <div class="wrapper">
                                <div class="container">
                                   @foreach($edit_services as $agreement)
                                    <form method="POST" action="{{ url('/update_agreement') }}">
                                    {{ csrf_field() }}
                                        <div class="form-group">
                                        <label for="name">Name</label>
                                            <input type="text" class="form-control" placeholder="Name" name="name" id="name" required value="{{$agreement->name}}">
                                      ...
                                      <script type="text/javascript">
                                       document.getElementById('active_yn').value="{{$agreement->active_yn}}";
                                       </script>
