...
<h4 class="singlefileupload"> Edit Agreement</h4>
         ...
         <div id="login">
            <div class="wrapper">
               <div class="container">
                  ...
                  <form method="POST" action="{{ url('/update_agreements') }}" enctype="multipart/form-data">
                     {{ csrf_field() }}
                     <div class="row">
                     ...
                     <div class="row">
                        ...
                        <!-- <div class="form-group col-lg-6">
                              ...
                              <?php 
                              $date_of_posting= date("Y", strtotime($creatives->date_of_posting));
                              ?>
                           ...
                           <div class="form-group col-lg-6">
                            ...
                            <script type="text/javascript">
                            document.getElementById('aggrement_type_id').value="{{$creatives->aggrement_type_id}}";
                            </script>
                           </div>
                     ...
                     <div>
                        ...
                        <input type="text" class="form-control" id="remark" name="remark"  value="{{$creatives->remark}}">
                           ...
                           <div class="form-group col-lg-6">
                              ...
                              <input type="date" class="form-control" id="date_of_upload" name="date_of_upload" required value="{{$creatives->date_of_upload}}" readonly>
                           </div>
                        </div>
                     </div>
                      ...
                      <div class="row">
                           ...
                           <div class="form-group col-lg-6">
                              ...
                              <input type="date" class="form-control" id="contract_start_date" name="contract_start_date" value="{{$creatives->contract_start_date}}" required  oninput="datecheck()">
                           </div>
                           <div class="form-group col-lg-6">
                              <label for="contract_end_date" class="ml-2">Contract  End date</label>
                              <input type="date" class="form-control" id="contract_end_date" name="contract_end_date" value="{{$creatives->contract_end_date}}" required oninput="datecheck()">
                           </div>
                           </div>
                    <!-- <div class="form-row">
...
<?php 
$year= date("Y", strtotime($creatives->created_date));
$month= date("m", strtotime($creatives->created_date));
...
<label class="ml-2">Uploaded File Preview</label>
   ...
   <img id="output2"  src="{{ENV('APP_URL')}}uploads/agreement_document/{{$year}}/{{$creatives->photo_url}}" style="width:100%;height:100%;padding:20px;">
   @elseif($creatives->file_type == 'other' && $creatives->other_document_type != 'ppt')
   <iframe src="{{ENV('APP_URL')}}uploads/agreement_document/{{$year}}/{{$creatives->photo_url}}" width="350" height="400"></iframe>
   @else
   <a href="{{ENV('APP_URL')}}uploads/agreement_document/{{$year}}/{{$creatives->photo_url}}">click to view powerpoint show</a>
   @endif
</div>
