...
<ol class="breadcrumb">
<li class="breadcrumb-item">Manage Auditor</li>
</ol>
</nav>
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="col-md-2 offset-4">
                <a href="{{ENV('APP_URL')}}add-auditor"> <button type="button" class="btn btn-block btn-secondary">Add</button></a>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $('#empTable').DataTable({
        ...
        //  ajax: "{{route('auditor.getauditor')}}",
        ajax: "{{ENV('APP_URL')}}auditor/getauditor",
         "language": {
            "infoFiltered":"",
