...
@include('admin/side-menu') 
  ...
  <div class="container-fluid col-lg-10 right_mainbox" id="viewlistmaster">
        ...
        <form method="POST" action="{{ url('/export_data_open_vendor') }}" enctype="multipart/form-data" id="singlefileupload"> 
        {{ csrf_field() }}
        <div class="row">
        <?php 
      ...
      <div class="col-lg-6">
       ...
       <input type="date" class="form-control"  id="to_date" name="to_date"  >
        ...
        <a class="btn btn-danger search-form1-btn" href="{{ENV('APP_URL')}}advertisement-id-vendor-open-list" role="button">Cancel</a>
        </form>
  ...
  var element = document.getElementById("open_advertisement_vendor_id_list");
...
'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
      ...
      $('#empTable').DataTable({
         ...
         ajax: {
          // url: "{{ route('advertisementidopenvendorlist.getadvertisement_id_open_vendor_list') }}",
          url:"{{ENV('APP_URL')}}advertisementidopenvendorlist/getadvertisement_id_open_vendor_list",
          type: 'GET',
          data: function (d) {
