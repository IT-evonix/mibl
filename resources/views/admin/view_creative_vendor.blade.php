...
?>
  <div class="container-fluid col-lg-10 right_mainbox" id="viewlistmaster">
      ...
      <!-- <label  class="fa fa-calendar input-icon"></label>-->
        ...
        <a class="btn btn-danger search-form1-btn btnFiterSubmitSearchpage" href="{{ENV('APP_URL')}}view-creative-vendor" role="button">Cancel</a>
        </div>
        </div>
        </div>
          ...
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-lg-12">
                ...
                <h4 class="viewdata"> Draft Creatives </h4>
              </div>
            </div>
          </div>
          <div class="card-body">
  ...
  element.classList.add("active");
   ...
   //   $.noConflict(); 
      ...
      ajax: {
      // url: "{{ route('creative_vendor.getcreatives_vendor') }}",
      url: "{{ENV('APP_URL')}}creative_vendor/getcreatives_vendor",
      type: 'GET',
      data: function (d) {
