...
@include('admin/side-menu')
            ...
            <h4 class="addeditdata"> Edit User Type </h4>
                <!-- START FORM -->
                                    ...
                                    {{ csrf_field() }}
                                        ...
                                        <label for="user_type_name">User Type Name</label>
                                            <input type="text" class="form-control" 
                                                placeholder="User Type Name" name="user_type_name" id="user_type_name" readonly required value="{{$user_type->user_type_name}}" >
                                      ...
                                      <script type="text/javascript">
                                       document.getElementById('active_yn').value="{{$user_type->active_yn}}";
                                       </script>
