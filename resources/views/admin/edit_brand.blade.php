...
@include('admin/side-menu')
            ...
            <li class="breadcrumb-item"><a href="{{ENV('APP_URL')}}view-brand">Manage Brand</a></li>
            <li class="breadcrumb-item active" aria-current="page">Edit Brand</li>
            </ol>
            </nav>               
            <h4 class="addeditdata"> Edit Brand </h4>    
                ...
                <div class="sign-in-up-form mt-5">
                    <div class="tab-content">
                        <div id="login">
                            <div class="wrapper">
                                <div class="container">
                                   @foreach($edit_services as $brand)
                                    <form method="POST" action="{{ url('/update_brand') }}">
                                    {{ csrf_field() }}
                                        <div class="form-group">
                                        <label for="name"> Name</label>
                                            <input type="text" class="form-control" placeholder="Brand Name" name="name" id="name" required value="{{$brand->name}}" >
                                        ...
                                        <label for="description"> Description</label>
                                            <input type="text" class="form-control"
                                                placeholder="Brand Description" name="description" id="description" value="{{$brand->description}}">
                                      ...
                                      <script type="text/javascript">
                                       document.getElementById('active_yn').value="{{$brand->active_yn}}";
                                       </script>
