  ...
  100% {
    ...
    <!-- start tab -->
			...
			@endif
                ...
                <!-- START UPLOAD -->
                <form method="POST" action="{{ url('/insert_bluk_upload') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="row yr-month">
                    ...
                    <div class="col-lg-6">
                    <a href="{{ENV('APP_URL')}}assets/sample_creatives_bulk.csv">Download Sample File To Import</a>
                    </div>
                </div>
...
<br><br>
<nav class="navbar navbar-light bg-light" id="bg-light">
<a href="{{ENV('APP_URL')}}generate_csv_file_incomplete" class="btn btn-info"  id="downloadLink" style="border-radius:25px;padding: 8px 30px;">Export Rejected Data</a>

<a href="{{ENV('APP_URL')}}bulk_upload_clear_all" class="btn btn-info"  style="border-radius:25px;padding: 8px 30px;">Clear All</a>
</nav>
<div class="tableFixHead">
<table class="table table-striped table-responsive" style="height:80%;font-size: small;" id="header-fixed">
  <thead>     
...
<script>
  ...
  var element = document.getElementById("bluk_upload");
...
$("#downloadLink").click(
    function(e) {   
        ...
        window.location="add-bulk-file-upload";
        window.focus();
    }
);
