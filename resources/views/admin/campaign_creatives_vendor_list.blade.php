  ...
  <div class="container-fluid col-lg-10 right_mainbox" id="viewlistmaster">
      ...
      <div class="col-lg-4">
       ...
       <input type="date" class="form-control"  id="to_date" name="to_date"  >
        ...
        <a class="btn btn-danger search-form1-btn" href="{{ENV('APP_URL')}}vendor-campaign-creatives-list" role="button">Cancel</a>
        <!--</form>-->
        </div>
        </div>
        </div>
      ...
      <div class="col-12">
		...
		@endif
              ...
              <div class="col-md-2 offset-4">
                <a href="{{ENV('APP_URL')}}vendor-add-campaign-creatives"> <button type="button" class="btn btn-block btn-secondary">Add</button></a>
...
//url: "http://www.miblmbank.com/vendorcampaigncreatives/vendorcampaigncreatives",
...
'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
      ...
      $('#empTable').DataTable({
         ...
         ajax: {
          ...
          url:"{{ENV('APP_URL')}}vendorcampaigncreatives/vendorcampaigncreatives",
          type: 'GET',
          data: function (d) {
