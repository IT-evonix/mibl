  ...
  <div class="container-fluid col-lg-10 right_mainbox" id="viewlistmaster">
      ...
      <div class="col-lg-4">
       ...
       <input type="month" class="form-control"  id="to_date" name="to_date" >
        ...
        <a class="btn btn-danger search-form1-btn" href="{{ENV('APP_URL')}}view-creative-vendor" role="button">Cancel</a>
        </div>
        </div>
        </div>
          ...
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-lg-12">
                ...
                <h4 class="viewdata"> Approved Creatives </h4>
              </div>
            </div>
          </div>
          <div class="card-body">
...
'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
      ...
      $('#empTable').DataTable({
         ...
         ajax: {
          // url: "{{ route('creative_approved.getcreatives_approved') }}",
          url: "{{ENV('APP_URL')}}bcreative_approvedrand/getcreatives_approved",
          type: 'GET',
          data: function (d) {
