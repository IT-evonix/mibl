...
<li class="breadcrumb-item active" aria-current="page">Manage Document Type</li>
</ol>
</nav>

  <h4 class="viewdata"> Manage Document Type </h4>
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <div class="row">
              ...
              <!-- <div class="col-md-1 offset-5">
                <a href="{{ENV('APP_URL')}}add-document-type"> <button type="button" class="btn btn-block btn-secondary">Add</button></a>

              </div> -->
            </div>
            <form method="POST" action="{{ url('/insert_document_type') }}">
            {{ csrf_field() }}
            <div class="row">
              ...
              <a class="btn btn-danger ml-2" href="{{ENV('APP_URL')}}view-document-type" role="button">Cancel</a>
              </div>
            </div>
          </form>
          </div>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $('#empTable').DataTable({
        ...
        //  ajax: "{{route('document_type.getdocument_type')}}",
        ajax: "{{ENV('APP_URL')}}document_type/getdocument_type",
         "language": {
            "infoFiltered":"",
