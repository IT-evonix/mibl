        ...
        <div class="search_filter_box">
            ...
            <div class="width100">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                    <form class="search" action="view-creatives-irdai" method="get" role="form" id="searchForm" >
                              {{ csrf_field() }}  
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <a class="btn btn-danger ml-2"  style="margin:0px !important" href="{{ENV('APP_URL')}}view-creatives-irdai" role="button">Cancel</a>
                            </div>
...
<!-- Modal Close -->
  ...
  $(document).ready(function () {
  var element = document.getElementById("manage_creatives_irdai");
