...
<li class="breadcrumb-item active" aria-current="page">Manage Language</li>
  ...
  <h4 class="viewdata"> Manage Language </h4>
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <div class="row">
              ...
              <!-- <div class="col-md-1 offset-5">
                <a href="{{ENV('APP_URL')}}add-language"> <button type="button" class="btn btn-block btn-secondary">Add</button></a>
            ...
            <div class="row">
              ...
              <lable class="font-weight-bolder pr-2 add-lable">Language</lable> <input type="text" id="language" name="language" placeholder='Language' required>
  
              <button class="btn btn-success ml-2" type="submit">Submit</button>
              <a class="btn btn-danger ml-2" href="{{ENV('APP_URL')}}view-language" role="button">Cancel</a>
              </div>
            </div>
          </form>
          </div>
 ...
 <script type="text/javascript">
    $(document).ready(function(){
      ...
      $('#empTable').DataTable({
        ...
        //  ajax: "{{route('language.getlanguage')}}",
        ajax: "{{ENV('APP_URL')}}language/getlanguage",
         "language": {
            "infoFiltered":"",
