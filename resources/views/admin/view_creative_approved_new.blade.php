        ...
        <div class="search_filter_box">
            ...
            <div class="width100">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                    <form class="search" action="view-creative-approved" method="get" role="form" id="searchForm" >
                              {{ csrf_field() }}  
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <a class="btn btn-danger ml-2"  style="margin:0px !important" href="{{ENV('APP_URL')}}view-creative-approved" role="button">Cancel</a>
                            </div>
                   ...
                   <?php }
                    ...
                    <div class="col-lg-2 manage_col4 ">
                        <div class=" ">
                            ...
                            <a href="https://videodelivery.net/{{$VIDEOID}}/downloads/default.mp4" type="button" class="btn download" download ><img src="assets/img/icon/download.png " class="img-fluid edit_download " width="70%"></a>
                            @else
                            <a href="{{ENV('APP_URL')}}uploads/{{@$year}}/{{@$month}}/{{@$creative->photo_url}}" type="button" class="btn download" download ><img src="assets/img/icon/download.png " class="img-fluid edit_download " width="70%"></a>
                            @endif

                            @else
                            <a href="{{ENV('APP_URL')}}uploads/{{@$year}}/{{@$month}}/original/{{@$creative->photo_url}}" type="button" class="btn download" download ><img src="assets/img/icon/download.png " class="img-fluid edit_download " width="70%"></a>
                             @endif
...
$(document).ready(function () {
var element = document.getElementById("manage_creative_approved");
