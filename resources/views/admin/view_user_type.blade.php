...
@include('admin/side-menu') 
  ...
  <h4 class="viewdata"> Manage User Type </h4>
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <div class="row">
              ...
              <!-- <div class="col-md-1 offset-5">
                <a href="{{ENV('APP_URL')}}add-user-type"> <button type="button" class="btn btn-block btn-secondary">Add</button></a>

              </div> -->
            </div>
            <form method="POST" action="{{ url('/insert_user_type') }}">
            {{ csrf_field() }}
            <div class="row">
              <div class="col-lg-12 ml-4">
              <lable class="font-weight-bolder pr-2 add-lable">User Type Name</lable> <input type="text" id="user_type_name" name="user_type_name" placeholder='User Type Name' required>
                <button class="btn btn-success ml-2" type="submit">Submit</button>
                <a class="btn btn-danger ml-2" href="{{ENV('APP_URL')}}view-user-type" role="button">Cancel</a>
              </div>
            </div>
          </div>
          </form>
 ...
 <script type="text/javascript">
    $(document).ready(function(){
      ...
      $('#empTable').DataTable({
         ...
         ajax: "{{ENV('APP_URL')}}user_type/getuser_type",
         "language": {
            "infoFiltered":"",
