...
@include('admin/side-menu')
            ...
            <!-- main content -->
            <div class="col-lg-6">
            <h4 class="addeditdata"> Add Document Type </h4>
                <!-- START FORM -->
                                    ...
                                    {{ csrf_field() }}
                                        <div class="form-group">
                                            <input type="text" class="form-control" 
                                                placeholder="Document Type Name" name="name" id="name" required pattern="[A-Z a-z]+">
                                            <label for="name">Document Type Name</label>
                                            <!-- <div class="line"></div> -->
                                        </div>
                                        <div class="form-group mt-5">
                                            <input type="text" class="form-control" 
                                                placeholder="Document Type Description" name="description" id="description">
