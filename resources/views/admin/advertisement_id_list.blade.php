...
@include('admin/side-menu') 
  ...
  <div class="container-fluid col-lg-10 right_mainbox" id="viewlistmaster">
        ...
        <div class="row">
        <div class="col-lg-4">
        <label for="department_id"><b>Status :</b></label>
      ...
      <div class="col-lg-4">
       ...
       <input type="date" class="form-control"  id="to_date" name="to_date"  >
        ...
        <a class="btn btn-danger search-form1-btn" href="{{ENV('APP_URL')}}advertisement-id-list" role="button">Cancel</a>
        </form>
          ...
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-lg-12">
                ...
                <h4 class="viewdata"> Advertisement Id List </h4>
              </div>
            </div>
          </div>
          <div class="card-body">
  ...
  var element = document.getElementById("advertisement_id_list");
...
'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
      ...
      $('#empTable').DataTable({
         ...
         ajax: {
          // url: "{{ route('advertisementidlist.getadvertisement_id_list') }}",
          url:"{{ENV('APP_URL')}}advertisementidlist/getadvertisement_id_list",
          type: 'GET',
          data: function (d) {
