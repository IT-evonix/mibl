...
@include('admin/side-menu')
            ...
            <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ENV('APP_URL')}}campaign-creatives-list">Manage Campaign Creatives</a></li>
                        ...
                        <div id="login">
                            <div class="wrapper">
                                <div class="container">
                                    ...
                                    <form method="POST" action="{{ url('/insert_campaign_creatives') }}" enctype="multipart/form-data" id="formId">
                                    {{ csrf_field() }}
