...
<li class="breadcrumb-item active" aria-current="page">Manage Vendor Type</li>
</ol>
</nav>
  <h4 class="viewdata"> Manage Vendor Type </h4>
    <div class="row">
      <div class="col-12">
        <div class="card">
            ...
            <div class="row">
             <div class="col-lg-12 ">
              ...
              <!-- <div class="col-md-1 offset-5">
                <a href="{{ENV('APP_URL')}}add-vendor-type"> <button type="button" class="btn btn-block btn-secondary">Add</button></a>
              </div> -->
              
            </div>
            <form method="POST" action="{{ url('/insert_vendor_type') }}">
            {{ csrf_field() }}
            <div class="row">
              <div class="col-lg-12 ml-4">
              <lable class="font-weight-bolder pr-2 add-lable">Vendor Type Name</lable> <input type="text" id="vendor_type_name" name="vendor_type_name" placeholder='Vendor Type Name' required>
                <button class="btn btn-success ml-2" type="submit">Submit</button>
                <a class="btn btn-danger ml-2" href="{{ENV('APP_URL')}}view-vendor-type" role="button">Cancel</a>
              </div>
            </div>
          </form>
  ...
  var element = document.getElementById("vendor_type");
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $('#empTable').DataTable({
        ...
        //  ajax: "{{route('vendor_type.getvendor_type')}}",
        ajax: "{{ENV('APP_URL')}}vendor_type/getvendor_type",
         "language": {
            "infoFiltered":"",
