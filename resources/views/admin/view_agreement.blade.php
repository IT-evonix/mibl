...
<li class="breadcrumb-item active" aria-current="page">Manage Agreement Type</li>
</ol>
</nav>

  <h4 class="viewdata"> Manage Agreement Type</h4>
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <form method="POST" action="{{ url('/insert_agreement') }}">
          {{ csrf_field() }}
          ...
          <a class="btn btn-danger ml-2" href="{{ENV('APP_URL')}}view-agreement" role="button">Cancel</a>
          </form>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $('#empTable').DataTable({
        ...
        //  ajax: "{{route('agreement.getagreement')}}",
         ajax: "{{ENV('APP_URL')}}agreement/getagreement",
         "language": {
            "infoFiltered":"",
