...
<li class="breadcrumb-item active" aria-current="page">Manage Brand</li>
  ...
  <h4 class="viewdata"> Manage Brand </h4>
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <div class="row">
              ...
              <!-- <div class="col-md-1 offset-5">
                <a href="{{ENV('APP_URL')}}add-brand"> <button type="button" class="btn btn-block btn-secondary">Add</button></a>

              </div> -->
            </div>
            <form method="POST" action="{{ url('/insert_brand') }}">
            {{ csrf_field() }}
            <div class="row">
              ...
              <a class="btn btn-danger ml-2" href="{{ENV('APP_URL')}}view-brand" role="button">Cancel</a>
              </div>
            </div>
          </form>
          </div>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $('#empTable').DataTable({
        ...
        //  ajax: "{{route('brand.getbrand')}}",
        ajax: "{{ENV('APP_URL')}}brand/getbrand",
         "language": {
            "infoFiltered":"",
