...
@include('admin/side-menu')
            ...
            <li class="breadcrumb-item active" aria-current="page">Edit User Role Permissions </li>
            </ol>
            </nav>
            <h4 class="addeditdata"> Edit User Role Permissions </h4>
                <!-- START FORM -->
                        ...
                        <div id="login">
                            <div class="wrapper">
                                ...
                                @foreach($edit_services as $user_type)
                                    <form method="POST" action="{{ url('/update_user_access') }}">
                                    {{ csrf_field() }}
                                    <div class="card">
                                    <div class="card-body">
                                    <b>User Name : </b>{{$data_user->name}}<br>
                                    <b>Role &nbsp;: </b>{{$data_user->user_type}}<br>
                                    </div>
                                    </div>   <br>
