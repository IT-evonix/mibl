        ...
        <div class="search_filter_box">
            ...
            <div class="width100">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                    <form class="search" action="view-advance-search" method="get" role="form" id="searchForm" >
                              {{ csrf_field() }}  
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <a class="btn btn-danger ml-2"  style="margin:0px !important" href="{{ENV('APP_URL')}}view-advance-search" role="button">Cancel</a>
                            </div>
                   ...
                   <?php }
                    ...
                    <div class="col-lg-2 manage_col4 ">
                        ...
                        @if($user_type == 'Super Admin' || $user_type == 'Admin User' )
                            ...
                            <a href="javascript:void(0);"  onclick="myFunction_sharing('<?php echo $creative->id;?>','not')" class="btn btn-danger sharebuttons"> <img src="{{ENV('APP_URL')}}assets/images/share_icon_1.png">
                ...
                <div class="testbox_div{{$creative->id}}" id="testbox{{$creative->id}}">
                    <div class="testbox_div_inner{{$creative->id}}">
                        <div class="testbox_div_innerwhite{{$creative->id}}">
                            <a href="javascript:void(0);"  onclick="myFunction_sharing('<?php echo $creative->id;?>','close')" style="float:right;"><span class="ad_list_imagepopup_closessss">X</span></a>  
