...
<h4 class="singlefileupload"> Single Adaptation File Upload</h4>
   ...
   <div class="sign-in-up-form">
      <div class="tab-content">
         <div id="login">
            <div class="wrapper">
               <div class="container">
                  <form method="POST" action="{{ url('/insert_single_file_upload_adaptation') }}" enctype="multipart/form-data" id="singlefileupload"> 
                     {{ csrf_field() }}
                     <div class="row">
                     ...
                     <label for="archive_category_id">Archive Category</label>
                        <select id="archive_category_id" name="archive_category_id" class="form-control btnFiterSubmitSearchpage"  required>
                     ...
                     <div>
                        <div class="row">
                           ...
                           <div class="form-group col-lg-6">
                              ...
                              <input type="text" class="form-control btnFiterSubmitSearchpage bg-body-secondary" id="date_of_upload" name="date_of_upload" required value="<?php echo date('d/m/Y');?>" readonly>
                           </div>
                        </div>
                     </div>
...
<script>
   $(document).ready(function () {
    var element = document.getElementById("add_single_file_upload_adaptation");
...
<script>
//   $(document).ready(function () {
//   var element = document.getElementById("single_file_upload");
//   element.classList.add("active");
//   });
</script>
<script>
