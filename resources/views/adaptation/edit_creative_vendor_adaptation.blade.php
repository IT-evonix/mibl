...
<h4 class="singlefileupload"> Edit Adaptation Creatives</h4>
      ...
      <div class="tab-content">
         <div id="login">
            <div class="wrapper">
               <div class="container">
                   @foreach($edit_services as $creatives)
                  <form method="POST" action="{{ url('/update_creative_vendor_adaptation') }}" enctype="multipart/form-data">
                     {{ csrf_field() }}
                     <div class="row">
...
$img=$_ENV['APP_URL']."upload_vendor/".@$year."/".@$month."/".@$creatives->photo_url;
...
<br>
<a href="javascript:void(0);" onclick="myFunction_copy_link()" class="btn btn-danger" style="font-size:13px;border-radius:50px;"><i class="fa fa-link" aria-hidden="true"></i> Copy Link</a>
</div>   
...
<script>
$(document).ready(function () {
var element = document.getElementById("manage_adaptation");
element.classList.add("active");
...
function getids()
 {
     ...
     if(result.success == '200'){
      ...
      window.location.href="{{ENV('APP_URL')}}view-creative-vendor-approved-adaptation";
      });
      }
