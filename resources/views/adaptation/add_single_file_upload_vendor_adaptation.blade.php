...
<h4 class="singlefileupload"> Upload Adaptation Creative </h4>
   ...
   <div class="sign-in-up-form">
      <div class="tab-content">
         <div id="login">
            <div class="wrapper">
               <div class="container">
                  <form method="POST" action="{{ url('/insert_single_file_upload_vendor_adaptation') }}" enctype="multipart/form-data" id="singlefileupload"> 
                     {{ csrf_field() }}
                     <div class="row">
...
<script>
   $(document).ready(function () {
    var element = document.getElementById("upload_adaptation");
...
<script>
   ...
   this.className += " active";
      ...
      var _token = jQuery('input[name="_token"]').val();
      jQuery.ajax({
      url: "{{ENV('APP_URL')}}get_advertisement_id_details_adaptation",
      type: "POST",
