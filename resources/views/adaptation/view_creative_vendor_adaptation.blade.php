...
?>
  <div class="container-fluid col-lg-10 right_mainbox" id="viewlistmaster">
        ...
        <input type="text" class="form-control btnFiterSubmitSearchpage" placeholder="Advertisement Id" id="advertisement_id" name="advertisement_id">
        </div>
        <div class="col-lg-4">
        <label for="archive_category_id"><b>Archive Category :</b></label>
        <select class="form-control btnFiterSubmitSearchpage" placeholder="Archive Category" id="archive_category_id" name="archive_category_id">
        ...
        <select class="form-control btnFiterSubmitSearchpage"  id="department_id" name="department_id">
          <option value="">--Select--</option>
          <?php
   ...
   <!--    <label  class="fa fa-calendar input-icon"></label>-->
      ...
      <!-- <label  class="fa fa-calendar input-icon"></label>-->
        ...
        <a class="btn btn-danger search-form1-btn btnFiterSubmitSearchpage" href="{{ENV('APP_URL')}}view-creative-vendor-adaptation" role="button">Cancel</a>
        </div>
        </div>
        </div>
          ...
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-lg-12">
                ...
                <h4 class="viewdata"> Draft Adaptation Creatives </h4>
              </div>
            </div>
          </div>
          <div class="card-body">
  ...
  @include('admin/footer')
    ...
    //  $.noConflict(); 
      ...
      ajax: {
      // url: "{{ route('creative_vendor_adaptation.getcreatives_vendor_adaptation') }}",
      url:"{{ENV('APP_URL')}}creative_vendor_adaptation/getcreatives_vendor_adaptation",
      type: 'GET',
      data: function (d) {
